    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="fixlogo">
                <a href="#"><img height="70" width="70" src="img/logofonce.png" alt="Logo Coupe de l'X"></a>
            </div>
            <div class="item active">
                <img src="img/pompoms.jpg" alt="Infrastructures sportives">
                <div class="container">
                    <div class="carousel-caption">
                        <h1 style="font-size:44px" class="oncarousel">Coupe de l'X 2017</h1>
                        <p style="font-size:24px" class="oncarousel">Le 19 octobre 2017 sur le campus de Polytechnique</p>
                    </div>
                </div>
            </div>
            <div class="item">
                <img src="img/volley.jpg" alt="Volley-ball">
                <div class="container">
                    <div class="carousel-caption">
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7 col-md-push-5">
                <h2 class="featurette-heading">Des activités folles !</h2>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">Une des plus grosses soirées de l'année !</h2>
                <p class="lead">C'est la traditionnelle <b>Nuit du Styx</b> qui viendra clôturer la Coupe de l'X 2017 ! Au programme [...] ! Bref, c'est l'évènement immanquable de l'automne 2017.</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-responsive center-block" src="http://nuitdustyx.binets.fr/images/affiche_NdS_sn_skyn_white.png" alt="Affiche Nuit du Styx">
            </div>
        </div>